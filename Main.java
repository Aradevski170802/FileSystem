public class Main {
    public static void main(String[] args) {
        ...
        TreeNode<FileSystemItem<?>> file1 = new TreeNode<>(new FileSystemItem<>("File1"), "File1", "WTF/Folder1/File1");
        ...
        TreeNode<FileSystemItem<?>> file2 = new TreeNode<>(new FileSystemItem<>("File2"), "File2", "WTF/Folder1/Subfolder1/File2");
